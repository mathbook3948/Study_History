...
inception_model = InceptionV3(input_shape = (150, 150, 3), include_top = False, weights = None) # 구글에서 만든 InceptionV3모델 불러오기. 단, 가중치 값은 안불러옴

inception_model.load_weights("./asset/model/inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5") # 가중치 데이터를 따로 불러옴
